...
class _GigaTurnipApiClient implements GigaTurnipApiClient {
  ...
  Future<PaginationWrapper<UserActivity>> getUserActivity(
    ...
    final Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<PaginationWrapper<UserActivity>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = PaginationWrapper<UserActivity>.fromJson(
      _result.data!,
  ...
  Future<PaginationWrapper<ConditionalStage<dynamic>>> getConditionalStages(
    ...
    final value = PaginationWrapper<ConditionalStage<dynamic>>.fromJson(
      _result.data!,
  ...
  Future<ConditionalStage<dynamic>> getConditionalStageById(
    ...
    final Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<ConditionalStage<dynamic>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = ConditionalStage<dynamic>.fromJson(
      _result.data!,
      (json) => json as dynamic,
    );
    return value;
  ...
  Future<TaskStageDetail> getTaskStageById(
    ...
    final Map<String, dynamic>? _data = null;
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<TaskStageDetail>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = TaskStageDetail.fromJson(_result.data!);
    return value;
  }
  ...
  Future<PaginationWrapper<Volume>> getVolumes(
    ...
    final Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<PaginationWrapper<Volume>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = PaginationWrapper<Volume>.fromJson(
      _result.data!,
