...
import '../widgets/campaign_card/card_message.dart';

class WebCampaignListItemWithProgress extends StatelessWidget {
  final repository.Campaign data;
  final void Function()? onTap;

  const WebCampaignListItemWithProgress({
    Key? key,
    required this.data,
    this.onTap,
  }) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      margin: EdgeInsets.symmetric(horizontal: 10.0, vertical: 10.h),
